...
const Flash = (function (_Tech) {
  ...
  function Flash(options, ready) {
    ...
    const _this = possibleConstructorReturn(this, _Tech.call(this, options, ready));
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    if (!options.swf) {
      ...
      options.swf = require('@/assets/video-js.swf');
    }
  ...
  Flash.prototype.buffered = function buffered() {
    if (!this.el_.vjs_getProperty) return;
...
const _readWrite = ['rtmpConnection', 'rtmpStream', 'preload', 'defaultPlaybackRate', 'playbackRate', 'autoplay', 'loop', 'controls', 'volume', 'muted', 'defaultMuted'];
const _readOnly = ['networkState', 'readyState', 'initialTime', 'startOffsetTime', 'paused', 'ended', 'videoWidth', 'videoHeight'];
...
for (let _i = 0; _i < _readOnly.length; _i++) {
...
Flash.getEmbedCode = function (swf, flashVars, params, attributes) {
  ...
  if (flashVars) {
    Object.getOwnPropertyNames(flashVars).forEach((key) => {
